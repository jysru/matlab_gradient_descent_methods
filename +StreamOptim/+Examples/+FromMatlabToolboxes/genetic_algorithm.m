...
options = optimoptions('ga','ConstraintTolerance',1e-6, 'PlotFcn', @gaplotbestf, Display='iter', PopulationSize=1000, MaxStallGenerations=150);

[phi, fval, exitflag, output, population, scores] = ga(fobj, n, [], [], [], [], lb, ub, [], options);
