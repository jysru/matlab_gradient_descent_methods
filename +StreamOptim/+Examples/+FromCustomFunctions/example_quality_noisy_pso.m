...
options = optimoptions( ...
    'particleswarm', 'SwarmSize', 10, 'InitialSwarmSpan',2*pi, 'MaxStallIterations',20, 'PlotFcn','pswplotbestf', 'FunctionTolerance', 0.001);
[x, fval, exitflag, output, points] = particleswarm(fobj, n, -pi*ones(n,1), +pi*ones(n,1), options);
