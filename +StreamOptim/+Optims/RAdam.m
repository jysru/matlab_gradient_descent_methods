function [x_opt, fval, history] = RAdam(func, x0, alpha, opts)
    ...
    rho_inf = 2 / (1 - 0.999) - 1; % rho_inf as defined in RAdam paper
    ...
    for iter = 1:opts.maxIter
        ...
        [x_new, m, v, rho_inf] = StreamOptim.Optims.Steps.RAdamStep(x, grad, m, v, rho_inf, iter, alpha=alpha);
