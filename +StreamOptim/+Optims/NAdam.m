function [x_opt, fval, history] = NAdam(func, x0, alpha, opts)
    % NAdam (Nesterov Accelerated Adam) optimization
    % 
    % Inputs:
    ...
    for iter = 1:opts.maxIter
        ...
        [x_new, m, v] = StreamOptim.Optims.Steps.NAdamStep(x, grad, m, v, iter, alpha=alpha);
